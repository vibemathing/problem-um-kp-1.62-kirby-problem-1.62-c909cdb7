...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.62-kirby-problem-1.62-c909cdb7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.62"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.62-kirby-problem-1.62-c909cdb7-v1",
      "problem_contract_sha256": "051007c984115432b704d6c0ee679f95c61280f327e2faad9738233f77d15160",
      "problem_id": "problem:um-kp-1.62-kirby-problem-1.62-c909cdb7",
      "route_id": "route:um-kp-1.62-kirby-problem-1.62-c909cdb7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.62-kirby-problem-1.62-c909cdb7-source-fidelity-01",
      "graph_id": "graph:um-kp-1.62-kirby-problem-1.62-c909cdb7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.62-kirby-problem-1.62-c909cdb7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.62-kirby-problem-1.62-c909cdb7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Are all good boundary links topologically slice? Freely topologically slice? (b) A special case of interest: Is the Whitehead double of the Borromean rings (with any choice of clasps) topologically slice?"
          },
          "statement_sha256": "391db4d3da6cb7050b5cf99e9e308444485ff62b1c947352944d1ba3fa72dbc1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.62-kirby-problem-1.62-c909cdb7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.62-kirby-problem-1.62-c909cdb7-root",
      "route_id": "route:um-kp-1.62-kirby-problem-1.62-c909cdb7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.62-729dcd73a414",
        "url": "https://www.unsolvedmath.com/problems/KP-1.62"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
